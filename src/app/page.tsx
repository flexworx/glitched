...
const FEATURES = [
  ...
  { title: 'Build Agent', description: 'Create your own AI agent with 34-trait personality system', icon: '🤖', color: '#8B5CF6', href: '/soul-forge' },
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto px-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/soul-forge" className="px-8 py-4 border border-neon-green text-neon-green font-orbitron uppercase tracking-wider text-lg hover:bg-neon-green/10 transition-colors">
              BUILD AGENT
            </Link>
          </div>
        </div>
