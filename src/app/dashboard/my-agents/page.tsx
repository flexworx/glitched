  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <Link href="/byoa/builder" className="px-4 py-2 bg-[#8b5cf6] text-white font-bold text-sm rounded-xl hover:bg-[#8b5cf6]/90 transition-all">
          + Build New Agent
        </Link>
      </div>
      ...
      <div className="bg-[#0d0d1a] border border-white/10 rounded-xl p-8 text-center">
        ...
        <Link href="/byoa/builder" className="px-6 py-3 bg-[#8b5cf6] text-white font-bold rounded-xl hover:bg-[#8b5cf6]/90 transition-all inline-block">
